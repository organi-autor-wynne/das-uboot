...
#ifdef CONFIG_LDO_BYPASS_CHECK		/*modify by wynne at 20161129*/
...
const struct mx6dq_iomux_ddr_regs mx6dq_ddr_ioregs = {
...
const struct mx6dq_iomux_grp_regs mx6dq_grp_ioregs = {
 ...
 */
static void spl_dram_init(int width, int size_mb)
{
